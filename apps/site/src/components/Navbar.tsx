    ...
    <header className="sticky top-0 z-50 border-b border-border/80 bg-background/90 backdrop-blur-xl">
      <div className="mx-auto grid h-16 max-w-[1500px] grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-4 md:grid-cols-[minmax(210px,240px)_minmax(260px,1fr)_auto] md:gap-6 md:px-5 lg:px-8">
        <Link href="/" className="flex items-center gap-2.5" aria-label="JoyMaaS 文档首页">
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-indigo-600 to-violet-500 text-white shadow-sm shadow-indigo-500/20">
        ...
        <nav className="flex items-center justify-end gap-1">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden items-center gap-1 rounded-lg px-3 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary/5 lg:inline-flex"
          >
            控制台
